...
<body>
  ...
  <div id="sobre" class="heading-index">
    <h1 style="text-shadow: 0.1em 0.1em 0.2em #87F">Bem Vindo</h1>
</div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="panel panel-default" style="border-color: #847BF6;box-shadow: 6px 6px 10px #847BF6;">
                ...
                <h1>Clique aqui para consultar ou incluir usuários: </h1>
        <br><br>
                <a class="btn btn-primary" href="consultaUsuario.php" role="button">Consultar Usuários</a>
