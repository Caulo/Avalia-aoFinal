    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="valida.php" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="senha" class="form-control"  placeholder="Digite sua senha" required autofocus />
            ...
            <div class="modal-footer" style="text-align: center;">
                <p>Não é cadastrado? <a href="#" class="login-link">Clique aqui!</a></p>
            </div>
        </div>
    </div>
</div>
